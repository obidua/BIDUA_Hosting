...
async def seed_pricing_data():
    ...
    for plan in all_plans:
        ...
        if 'cpu_optimized' in plan['plan_type']:
            ...
            features.append("Intel® Xeon® Gold")
    ...
    print(f"✅ Inserted {len(all_plans)} hosting plans")
    ...
    print("\n📋 Sample plans:")
    for row in sample:
        print(f"  - {row['name']} ({row['plan_type']}): ₹{row['monthly_price']}/month")
    
    await conn.close()
    print("\n✅ Pricing data seeding complete!")
