    ...
    <div className="bg-slate-950 text-slate-300 py-16 px-4">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <section className="bg-slate-900/30 border border-slate-800 rounded-xl p-6 space-y-3">
          ...
          <p className="text-sm text-slate-300">
            Contact BIDUA Industries Pvt Ltd, Suite 209, C-104, Sector 65, Noida, Uttar Pradesh 201301, India (GSTIN: 09AANCB0882D1ZM) | Email: support@biduapods.com | Phone: +91 95129 21903.
          </p>
        </section>
      </div>
    </div>
