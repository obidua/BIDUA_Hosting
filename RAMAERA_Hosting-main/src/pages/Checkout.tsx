              ...
              {currentStep === 1 && (
                <div>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-white font-semibold">
                              {serverConfig.storage}GB SSD
                              {serverConfig.extraStorage ? ` (+${serverConfig.extraStorage}GB)` : ''}
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-white font-semibold">
                              {serverConfig.bandwidth}TB
                              {serverConfig.extraBandwidth ? ` (+${serverConfig.extraBandwidth}TB)` : ''}
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <button
                    ...
                    className="mt-8 w-full bg-gradient-to-r from-cyan-600 to-teal-600 text-white px-6 py-4 rounded-lg font-bold hover:from-cyan-500 hover:to-teal-500 transition-all flex items-center justify-center"
                  >
                    Continue to Billing
          ...
          <div className="lg:col-span-1">
            <div className="bg-slate-900 rounded-2xl border-2 border-cyan-500/30 p-6 sticky top-4">
              ...
              <div className="space-y-4 mb-6">
                ...
                {serverConfig.extraStorage && (
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-400">Extra Storage</span>
                    <span className="text-white font-semibold">+₹{Math.round(serverConfig.extraStorage * 50).toLocaleString()}/mo</span>
                  </div>
                )}
                
                {serverConfig.extraBandwidth && (
                  <div className="flex justify-between text-sm">
                    <span className="text-slate-400">Extra Bandwidth</span>
                    <span className="text-white font-semibold">+₹{Math.round(serverConfig.extraBandwidth * 100).toLocaleString()}/mo</span>
                  </div>
                )}
                ...
                <div className="border-t border-slate-700 pt-4">
                  <div className="flex justify-between text-sm mb-2">
                    ...
                    <span className="text-white capitalize">{serverConfig.billingCycle}</span>
                  </div>
                  
                  {serverConfig.discount > 0 && (
                    <div className="flex justify-between text-sm text-green-400 mb-2">
                      <span>Discount</span>
                      <span>-₹{serverConfig.discount.toLocaleString()}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="border-t border-slate-700 pt-4 mb-6">
                <div className="flex justify-between items-baseline">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-bold text-white">₹{serverConfig.totalPrice.toLocaleString()}</div>
                    <div className="text-sm text-cyan-400">₹{serverConfig.monthlyPrice.toLocaleString()}/mo effective</div>
                  </div>
                </div>
              </div>
