...
export function Pricing() {
  ...
  return (
    <div className="bg-slate-950">
      <section className="text-white pt-6 pb-8 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-3xl md:text-6xl font-bold mb-4 md:mb-6 leading-tight">
              Cloud Solutions Pricing
            </h1>
            <p className="text-lg md:text-2xl mb-3 md:mb-4 text-cyan-100">
              Enterprise-grade cloud servers powered by Intel® Xeon® Gold Processors
            </p>
            <p className="text-sm md:text-lg text-cyan-200 mb-6 md:mb-8">
      ...
      {/* Inline Filters Section - Mobile Optimized */}
      <section className="py-6 md:py-12 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 md:mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2 md:mb-4">Choose Your Configuration</h2>
            <p className="text-sm md:text-lg text-slate-400">Select billing cycle and server type to view pricing</p>
          </div>

          {/* Server Type Selection - Mobile First */}
          <div className="mb-6 md:mb-8">
            <label className="block text-sm font-semibold text-white mb-3 px-1">
              Server Type
            </label>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {planTypes.map((type) => (
                <button
                  ...
                  className={`flex items-center space-x-3 px-4 py-4 rounded-xl font-semibold transition-all shadow-md ${
                    selectedType === type.id
                      ? 'bg-cyan-600 text-white shadow-lg border-2 border-cyan-400'
                      : 'bg-slate-950 text-cyan-400 border-2 border-cyan-500 hover:bg-slate-800'
                  }`}
                >
          ...
          {/* Billing Cycle Selection - Mobile First */}
          <div>
            <label className="block text-sm font-semibold text-white mb-3 px-1">
              Billing Cycle
            </label>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 md:gap-3">
              {billingCycles.map((cycle) => (
                <button
                  ...
                  className={`px-3 py-3 rounded-lg font-semibold text-xs md:text-sm transition-all ${
                    billingCycle === cycle.id
                      ? 'bg-cyan-600 text-white shadow-md'
                      : 'text-slate-300 hover:text-white bg-slate-950 hover:bg-slate-800 border border-cyan-500/30'
                  }`}
                >
                  <div>{cycle.name}</div>
                  {cycle.discount > 0 && (
